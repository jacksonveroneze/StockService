...
using JacksonVeroneze.StockService.Application.Validations.ValidationPattern.Rules;
...
namespace JacksonVeroneze.StockService.Application.Validations.OutputItem
{
    ...
    public class OutputItemValidator : BaseValidator, IOutputItemValidator
    {
        ...
        public async Task<NotificationContext> ValidateUndoItemAsync(Guid outputId, Guid outputItemId)
        {
            ...
            IList<Notification> validationResult =
                new Validator<Domain.Entities.Output>()
                    .AddRule(new OutputExistsValidationRule())
                    .AddRule(new OutputIsClosedValidationRule())
                    .AddRule(new OutputItemExistsValidationRule(outputItemId))
                    .AddRule(new OutputItemWithMovementValidationRule(outputItemId))
                    .Validate(await _outputRepository.FindAsync(outputId));
