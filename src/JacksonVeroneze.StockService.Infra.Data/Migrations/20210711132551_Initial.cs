...
namespace JacksonVeroneze.StockService.Infra.Data.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "devolution_item",
                schema: "stock",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    amount = table.Column<int>(type: "integer", nullable: false),
                    devolution_id = table.Column<Guid>(type: "uuid", nullable: false),
                    product_id = table.Column<Guid>(type: "uuid", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    updated_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    deleted_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_devolution_item", x => x.id);
                    table.ForeignKey(
                        name: "fk_devolution_item_devolution_devolution_id",
                        column: x => x.devolution_id,
                        principalSchema: "stock",
                        principalTable: "devolution",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_devolution_item_product_product_id",
                        column: x => x.product_id,
                        principalSchema: "stock",
                        principalTable: "product",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                name: "devolution_item_movement_item",
                schema: "stock",
                columns: table => new
                {
                    devolution_items_id = table.Column<Guid>(type: "uuid", nullable: false),
                    movement_items_id = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_devolution_item_movement_item", x => new { x.devolution_items_id, x.movement_items_id });
                    table.ForeignKey(
                        name: "fk_devolution_item_movement_item_devolution_item_devolution_ite",
                        column: x => x.devolution_items_id,
                        principalSchema: "stock",
                        principalTable: "devolution_item",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_devolution_item_movement_item_movement_item_movement_items_id",
                        column: x => x.movement_items_id,
                        principalSchema: "stock",
                        principalTable: "movement_item",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_devolution_item_devolution_id",
                schema: "stock",
                table: "devolution_item",
                column: "devolution_id");

            migrationBuilder.CreateIndex(
                name: "ix_devolution_item_product_id",
                schema: "stock",
                table: "devolution_item",
                column: "product_id");

            migrationBuilder.CreateIndex(
                name: "ix_devolution_item_movement_item_movement_items_id",
                schema: "stock",
                table: "devolution_item_movement_item",
                column: "movement_items_id");
